...
Patch130:	awesome-3.5.9-qubes-menu-0001-Remove-old-code-and-reindent-one-line.patch
Patch131:	awesome-3.5.9-qubes-menu-0002-Pass-vm-data-in-array.patch
Patch132:	awesome-3.5.9-qubes-menu-0003-Make-VM-type-available-to-menu-creation.patch
Patch133:	awesome-3.5.9-qubes-menu-0004-Separate-menuitem-creators.patch
Patch134:	awesome-3.5.9-qubes-menu-0005-Add-hooks-to-menu-building-to-allow-filtering-tweaks.patch
Patch140:	awesome-3.5.9-qubes-fix-issue-2780.patch
Patch150:	awesome-3.5.9-qubes-4.0-border-colors.patch
...
%patch130 -p1 -b .qubes-menu-1
%patch131 -p1 -b .qubes-menu-2
%patch132 -p1 -b .qubes-menu-3
%patch133 -p1 -b .qubes-menu-4
%patch134 -p1 -b .qubes-menu-5
%patch140 -p1 -b .issue-2780
%patch150 -p1 -b .qubes-4-border-colors
